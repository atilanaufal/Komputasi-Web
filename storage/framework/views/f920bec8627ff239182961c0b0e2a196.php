            ...
            <?php $__currentLoopData = $biodatas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $biodata): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    ...
                    <td>
                        ...
                        <form action="<?php echo e(route('biodatas.destroy', $biodata->id)); ?>" method="POST"
...
<?php /**PATH J:\VScode Project\Komputasi Wb\pemrograman-web-a\resources\views/biodatas/index.blade.php ENDPATH**/ ?>