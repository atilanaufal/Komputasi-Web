...
<?php $__env->startSection('title', 'PaketKita'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="  bg-light  rounded-1">
        <div class="container-fluid d-flex flex-column flex-md-row align-items-center justify-content-between py-5 px-4">
            <img src="<?php echo e(asset('icon/logo2.2.png')); ?>" style="width: 240px;
    ...
    <div class="container mt-5">
        <div class="row g-4">
            ...
            <div class="col-md-6">
                <div class="card h-100 shadow-sm border-0 rounded-4">
                    <div class="card-body text-center">
                        <img src="<?php echo e(asset('icon/goal.png')); ?>" alt="Misi" class="mb-3" style="width: 80px;">
            ...
            <div class="col-md-6">
                <div class="card h-100 shadow-sm border-0 rounded-4">
                    <div class="card-body text-center">
                        <img src="<?php echo e(asset('icon/services.png')); ?>" alt="Layanan" class="mb-3" style="width: 80px;">
...
<?php echo $__env->make('layout.main_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH J:\VScode Project\Komputasi Wb\paketkita3\resources\views/main/about.blade.php ENDPATH**/ ?>