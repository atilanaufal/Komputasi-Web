    ...
    <body>
        <div class="d-flex flex-column">
            <div class="navbar navbar-expand-sm bg-dark navbar-dark sticky-top ">
                <div class="ms-5 container-fluid ">
                    <div class="nav nav-pills ">
                        <div class="nav-item  ">
                            <a href="#" class="nav-link active fw-bold text-black bg-light">Daftar</a> 
                        </div>
                        <div class="nav-item ms-3 ">
                            <a href="userlist.php" class="nav-link  fw-bold text-white">User List</a> 
                        </div>
                    </div>       
                </div>
            </div>
            <div class="container mt-3 d-flex flex-column justify-content-center" >
                ...
                <form method="post" action="konfirmasi.php" class="">
                    <div class="mb-3 mt-3">
